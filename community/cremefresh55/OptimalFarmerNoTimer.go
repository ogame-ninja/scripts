...
min_player_rank = 1500 // I recommend you set this to a reasonable number 
...
delay_after_spy_to_attack_missions = [60,120] // 1-2min - at least 1 min !! is highly recommended
delay_between_attack_missions = [3000,6000] //3-6 sek
delay_after_attack_to_next_planet = [30,60] // 2-3min
...
//### FARMER ###                   
farm_planets = ["P:4:361:9", "P:4:141:6", "P:3:411:9", "P:3:88:8", "P:2:247:7", "P:2:88:9", "P:1:248:9","P:1:88:10"]
sys_radius = 15// Spy radius of systems around each planet.. always same radius
